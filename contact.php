<?php
   if(isset($_POST['contact'])){
	   ...
	   $to = 'jawaad@emaadinternational.com';               
	   ...
	   // Additional headers
	   $headers .= 'To: '.$name.' <'.$to.'>' . "\r\n";
	   $headers .= 'From: <jawaad@emaadinternational.com>' . "\r\n";  
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-3">
            <div class="footer-wiz">
              <h3 class="footer-logo"><img src="assets/images/emaad_logo_d.png" alt="footer logo"/></h3>
